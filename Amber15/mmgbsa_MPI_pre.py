# mmpbsa_MPI_pre.py
# MM/PBSA analysis script in parallel (without final step)
# Usage:
#       mpiexec -np #processes python mmpbsa_MPI_pre.py $LIGLIST $RCPTRLIST $CONFIG
#
...
#    lig_inp_prmtop = 'lig.strip.strip.strip.' + prmtop
    ...
    cmplx_i = 'cmplx_i.prmtop'
    rcptr_i = 'rcptr_i.prmtop'
    lig_i = 'lig_i.prmtop'
